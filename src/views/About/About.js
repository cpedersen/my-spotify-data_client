    ...
    <section className={styles.container}>
      ...
      <div role="textbox" className={styles.helpSection}>
        ...
        <p>
          ...
          history and can be used to create a CSV file containing the user's
          playlists and songs. In this way, the user can always be assured that
          they have a backup of their Spotify data.
        </p>
        <p>
          ...
          parties. Your password is not saved to the My Spotify Data database.
        </p>
      </div>
    </section>
  );
