...
![Alt text](./src/images/LandingPage.jpg?raw=true "LandingPage"){:height="50%" width="50%"}
...
![Alt text](./src/images/SearchMyPlaylists.jpg?raw=true "SearchMyPlaylists"){:height="50%" width="50%"}
...
![Alt text](./src/images/ViewListeningHistory.jpg?raw=true "ViewListeningHistory"){:height="50%" width="50%"}
...
![Alt text](./src/images/ManageData.jpg?raw=true "ManageData"){:height="50%" width="50%"}
